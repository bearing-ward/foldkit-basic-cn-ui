  ...
  return h.div(
    ...
    [
      ...
      Progress.view({
        ...
        labelClassName: "progress-label-override",
        labelStyle: { color: "rgb(17, 24, 39)" },
        valueClassName: "progress-value-override",
        valueStyle: { fontVariantNumeric: "tabular-nums" },
        trackClassName: "progress-track-override",
        trackStyle: { blockSize: "0.5rem" },
        indicatorClassName: "progress-indicator-override",
