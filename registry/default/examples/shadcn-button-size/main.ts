          ...
          Button.view<Message>({
            ...
            toView: (attributes) =>
              h.button(
                [
                  ...attributes.button,
                  h.Class(`${Button.shadcnButtonClassName} px-2 py-1 text-xs`),
                ],
                ["Extra Small"]
              ),
          }),
            ...
            toView: (attributes) =>
              h.button(
                [
                  ...attributes.button,
                  h.Class(
                    `${Button.shadcnButtonClassName} px-2.5 py-1.5 text-sm`
                  ),
                ],
                ["Small"]
              ),
            ...
            toView: (attributes) =>
              h.button(
                [
                  ...attributes.button,
                  h.Class(
                    `${Button.shadcnButtonClassName} px-4 py-2.5 text-lg`
                  ),
                ],
                ["Large"]
              ),
