                      ...
                      Drawer.contentView<Message>({
                        children: [
                          ...
                          Drawer.descriptionView<Message>({
                            id: descriptionId,
                            children: [h.span([], ["حدد هدف نشاطك اليومي."])],
                          }),
                        ],
                      }),
                      h.div(
