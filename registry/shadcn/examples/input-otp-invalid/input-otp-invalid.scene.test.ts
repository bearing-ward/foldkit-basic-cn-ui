...
describe("Input OTP Invalid example", () => {
  test("renders and exercises the invalid variant", () => {
    Scene.scene(
      {
      ...
      Scene.expect(Scene.role("textbox", { name: "Digit 1" })).toHaveAttr("aria-invalid", "true"),
