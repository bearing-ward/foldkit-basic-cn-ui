...
const slotCount = 6;
const inputPattern = InputOtp.REGEXP_ONLY_DIGITS_AND_CHARS;
  ...
  return h.div(
    ...
    [
      h.div(
        [h.Class("space-y-1")],
        [
          h.h2([h.Class("text-lg font-semibold text-gray-950")], ["Alphanumeric"]),
          h.p([h.Class("text-sm text-gray-600")], ["Letters and numbers are accepted."]),
        ]
      ),
