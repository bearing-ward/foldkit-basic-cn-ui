...
export const update = (
  ...
  M.value(message).pipe(
    ...
    M.tagsExhaustive({
      ...
      ClickedCopyPaymentId: () => [evo(model, { openPaymentId: () => "" }), []],
      ClickedViewCustomer: () => [evo(model, { openPaymentId: () => "" }), []],
      ClickedViewPaymentDetails: () => [
