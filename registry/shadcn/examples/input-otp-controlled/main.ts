  ...
  return h.div(
    ...
    [
      h.div(
        [h.Class("space-y-1")],
        [
          h.h2([h.Class("text-lg font-semibold text-gray-950")], ["Controlled"]),
          h.p([h.Class("text-sm text-gray-600")], ["Enter your one-time password."]),
        ]
      ),
      h.div([h.Class("flex justify-center")], [otpView(model)]),
      h.p([h.Class("text-sm text-gray-600")], [`Value: ${model.digits.join("")}`]),
