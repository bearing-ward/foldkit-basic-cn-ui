export const shadcnPopoverTriggerClasses =
...
export const shadcnPopoverRootClasses = "relative inline-block";

export const shadcnPopoverPanelClasses =
...
export const shadcnPopoverBackdropClasses = "fixed inset-0 z-0";
