...
export const commandInputWrapperClasses =
...
export const commandListClasses =
  "max-h-72 overflow-y-auto overflow-x-hidden";

export const commandEmptyClasses = "py-6 text-center text-sm text-gray-500";

export const commandGroupClasses =
...
export const commandSeparatorClasses = "-mx-1 h-px bg-gray-200";

export const commandShortcutClasses =
