...
export const scrollAreaContentClasses =
  "space-y-4 text-sm leading-6 text-gray-700";

export const scrollAreaScrollbarClasses =
  "pointer-events-none absolute inset-y-1 right-1 w-1.5 rounded-full bg-gray-100";

export const scrollAreaThumbClasses = "min-h-8 rounded-full bg-gray-400";

export const scrollAreaCornerClasses =
  "pointer-events-none absolute bottom-0 right-0 h-2 w-2 bg-white";

export const scrollAreaFadeClasses =
