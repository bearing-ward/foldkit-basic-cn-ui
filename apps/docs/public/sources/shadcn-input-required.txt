...
export const UpdatedRequiredField = m("UpdatedRequiredField", {
  value: S.String,
});

export const Message = S.Union([UpdatedRequiredField]);
...
export const update = (
  ...
  M.value(message).pipe(
    ...
    M.tagsExhaustive({
      UpdatedRequiredField: ({ value }) => [
        evo(model, { requiredField: () => value }),
        [],
      ],
    })
  );
...
export const view = Submodel.defineView<Model, Message>((model): Html => {
  ...
  return field(h, {
    ...
    onInput: (value) => UpdatedRequiredField({ value }),
