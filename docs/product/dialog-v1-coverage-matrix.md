...
| Nested dialogs                                     | Deferred and should be documented as unsupported or unverified until tested.                                     |
| Scrollable content and sticky footer examples      | Docs follow-up after basic and destructive examples pass.                                                        |
